...
<title>我的订单</title>
  ...
  <center>
    ...
    <table border="1" bordercolor="#00ff00" cellpadding="5" cellspacing="1" width="500" height="80">
        ...
        <% 
            CachedRowSet rowSet = goods.getRowSet();// 获取储存在模型中的行信息
            if(rowSet==null) {
                out.print("商品数据库中没有哦");
                return;
            }
            ...
            if(totalPages >= 1) {
               ...
               for(int i=1,j=goods.getPageSize();i<=j&&flag;i++) {
                   ...
                   String commodity_price = rowSet.getString(2);
                   String orderNumber = rowSet.getString(3);
                   totalPrice += Double.parseDouble(commodity_price);
